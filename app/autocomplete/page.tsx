  ...
  return (
    <div className="max-w-[1200px] mx-auto text-[#e0e0e0] font-inter flex flex-col items-center justify-center">
      <div className="w-full mx-auto">
        <h1 className="text-5xl font-bold text-center mb-8">Autocomplete Optimisation: A Comparative Analysis</h1>
        <div className='text-center my-4 py-6'>
          <Link
            href="https://github.com/andywelly/autocomplete-lookup" 
            className="text-xl outline-double hover:bg-[var(--pacman-color)] hover:border-4 border-dashed hover:border-white px-6 py-2 rounded transition-all duration-300 mr-2"
          >
            Visit GitHub Repo
          </Link>
          <Link
            href="/report.pdf" 
            className="text-xl outline-double hover:bg-[var(--pacman-color)] hover:border-4 border-dashed hover:border-white px-6 py-2 rounded transition-all duration-300 ml-2"
          >
            Read Report
          </Link>
        </div>
